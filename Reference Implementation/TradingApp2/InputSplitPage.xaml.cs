...
namespace TradingApp2
{
    ...
    /// </summary>
    public sealed partial class InputSplitPage : LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var group = AccountDataSource.GetGroup((String)navigationParameter);
            ...
            else
            {
                ...
                {
                    var selectedItem = AccountDataSource.GetItem((String)pageState["SelectedItem"]);
